...
class srcMyCoon_Apps_Backoffice_Backend_KernelDevDebugContainer extends Container
{
    ...
    protected function getUserCreatePostControllerService()
    {
        ...
        return $this->services['MyCoon\\Apps\\Backoffice\\Backend\\Controller\\User\\UserCreatePostController'] = new \MyCoon\Apps\Backoffice\Backend\Controller\User\UserCreatePostController(new \MyCoon\Shared\Infrastructure\Bus\Command\InMemorySymfonyCommandBus(new RewindableGenerator(function () {
        ...
        }, 2)), ($this->services['serializer'] ?? $this->getSerializerService()));
    }
