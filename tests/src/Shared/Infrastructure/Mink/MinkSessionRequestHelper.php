...
namespace MyCoon\Tests\Shared\Infrastructure\Mink;
...
final class MinkSessionRequestHelper
{
    ...
    public function sendRequestWithPyStringNodeAndHeader($method, $url, $token, PyStringNode $body): void
    {
        $this->request($method, $url, ['content' => $body->getRaw(), 'token' => $token]);
    }
